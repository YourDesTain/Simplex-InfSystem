...
division.appendChild(document.createTextNode('Количество переменных  '));
...
division.appendChild(document.createTextNode('Количество ограничений  '));
...
butt.onclick = function () {
    ...
    try {
        ...
        if (e instanceof ReferenceError) {
            ...
            var1.setAttribute('placeholder', 'пустое значение');
            t = 1;
        }
    }
    ...
    try {
        ...
        if (e instanceof ReferenceError) {
            ...
            con1.setAttribute('placeholder', 'пустое значение');
            t = 1;
        }
    }
...
butt.appendChild(document.createTextNode("Продолжить"));
